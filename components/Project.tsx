...
export default function Project({ title, description, imageUrl, codeUrl, liveUrl }: ProjectProps) {
  ...
  return (
    ...
    >
      <section className='bg-gray-100 md:w-full lg:max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative md:h-[17.5rem] lg:h-[24rem] xl:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20'>
        <div className='pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-6 sm:max-w-[50%] flex flex-col h-full lg:text-sm md:group-even:ml-[27.5rem] lg:group-even:ml-[12.5rem] xl:group-even:ml-[18rem] justify-between'>
