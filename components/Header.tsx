  ...
  return (
    ...
    >
      <div>
        ...
        <h2 className='text-gray-800 dark:text-slate-200 sm:mt-2 mb-4 text-lg tracking-tight sm:text-xl font-semibold'>
        ...
        <p className='text-gray-600 dark:text-slate-400 max-w-xl'>
          ...
          the world of web development, primarily <strong>React.js / Next.js</strong>.
        </p>
      ...
      <div className='mt-6 lg:mt-6 xl:mt-0 flex justify-between sm:flex-row items-center sm:justify-start gap-4 font-medium'>
        ...
        <a
          className='bg-white p-3 sm:p-4 text-gray-700 hover:text-gray-950 flex items-center justify-center gap-2 rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-slate-200'
        ...
        <a
          className='bg-white p-3 sm:p-4 text-gray-700 flex justify-center items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-slate-200'
